...
var ASM_CONSTS = {
  3348112: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3348173: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3348237: function() {return Module.webglContextAttributes.powerPreference;},  
 3348295: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3348350: function($0) {performance.now = function() { return $0; };},  
 3348398: function($0) {performance.now = function() { return $0; };},  
 3348446: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _RunAsyncTask($taskName, $taskId, $args, cb) {
      /**
  ...
  function _RunSyncTask($taskName, $args) {
      /**
       * Converts a JavaScript string to a UTF-8 encoded memory buffer
       * and returns a pointer to it.
       *
...
var asmLibraryArg = {
  ...
  "RunAsyncTask": _RunAsyncTask,
  "RunSyncTask": _RunSyncTask,
